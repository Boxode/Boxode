          ...
          <div className='lg:grid lg:grid-cols-12 mx-auto justify-center'>
            <article className='relative z-10 px-4 sm:px-6 sm pb-10 md:pb-0 pt-10 md:pt-0 lg:mb-0 lg:px-0 lg:text-left lg:flex col-span-6 border-t-2 border-b-2 lg:border-r-2 border-gray-800/30 get-improve'>
              <div className='lg:py-24 px-4 sm:px-16'>
                <p className='text-white lg:text-left font-[Questrial] text-lg'>
                  Boxode's Community
                </p>
                <h4 className='mt-3 font-[SegoeBold] sm:mx-auto lg:mx-0 max-w-lg lg:text-left text-2xl lg:text-4xl text-white sm:mt-5'>
                  Get involved
                </h4>
                <p className='mt-3 font-[Questrial] sm:mx-auto lg:mx-0 max-w-lg lg:text-left text-base sm:text-lg text-neutral-200/80 sm:mt-5'>
                ...
                <div className='pt-4 flex flex-col'>
                  <Link
                    ...
                    className='text-white link link--arrowed inline-flex font-[Questrial] text-base sm:text-lg'
                  >
                    Happening Now{' '}
                    <svg
                  ...
                  <Link
                    ...
                    className='text-white link link--arrowed inline-flex font-[Questrial] text-base sm:text-lg pt-2'
                  >
                    Features Projects{' '}
                    <svg
                      className='arrow-icon'
                  ...
                  <Link
                    ...
                    className='text-white link link--arrowed inline-flex font-[Questrial] text-base sm:text-lg pt-4'
                  >
                    Contributing{' '}
                    <svg
                      className='arrow-icon'
