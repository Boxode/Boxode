...
<section id='about' className='border-t border-gray-100/5 pt-10'>
  <div>
  	<div className='flex items-center justify-center flex-col mt-16 mb-10'>
  		...
  		<h2 className='about text-6xl lg:text-8xl font-[SegoeBold] tracking-normal p-4 opacity-90 select-none'>Nosotros
  		</h2>
  		<p className='text-gray-100/50 text-md px-6 text-center lg:text-2xl font-[Questrial]'>Te dejamos un poco de
  			información relevante sobre nuestra misión y visión.</p>
  	</div>
  	  	  ...
  	  	  <div className="relative z-10 px-4 sm:px-6 sm:text-center lg:mb-0 lg:px-0 lg:text-left lg:flex col-span-6">
  	  	  	<div className="lg:py-24">
  	  	  	  ...
  	  	  	  <p className="mt-3 font-[Questrial] sm:mx-auto lg:mx-0 max-w-lg text-center lg:text-left text-base sm:text-xl text-neutral-200/40 sm:mt-5">
  	  	  	  	Proporcionar soluciones de software innovadoras y de alta calidad a nuestros clientes, mejorando sus
  	  	  	  	procesos empresariales y ayudándoles a alcanzar sus objetivos de negocio de manera eficiente y rentable.
  	  	  	  	Nuestro compromiso es crear una experiencia de usuario excelente y brindar un servicio al cliente
  	  	  	  	inigualable.
  	  	  	  </p>
  	  	  	</div>
  	  	  </div>
  	  	...
  	  	<div className="lg:grid lg:grid-cols-12 mx-auto lg:gap-16 justify-center">
  	  	  <div className="relative z-10 px-4 sm:px-6 sm:text-center lg:mb-0 lg:px-0 lg:text-left lg:flex col-span-6">
  	  	  	<div className="lg:py-24">
  	  	  	  ...
  	  	  	  <p className="mt-3 font-[Questrial] sm:mx-auto lg:mx-0 max-w-lg text-center lg:text-left text-base sm:text-xl text-neutral-200/40 sm:mt-5">
				  Ser la empresa preferida por los clientes en el desarrollo de soluciones de software y web, ofreciendo productos y servicios de alta calidad y 
				  tecnología avanzada. Nos esforzamos por ser una fuente de innovación y excelencia en el mercado, y por establecer relaciones duraderas y confiables 
				  con nuestros clientes. Buscamos fomentar un ambiente de trabajo colaborativo y motivador para nuestros empleados, alentándolos a alcanzar su máximo 
				  potencial y brindar un servicio impecable a nuestros clientes.
  	  	  	  </p>
  	  	  	</div>
  	  	  </div>
  	  	  <div className="mx-auto flex items-center justify-center lg:justify-start">
